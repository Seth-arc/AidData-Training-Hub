...
echo "<p><a href='" . get_permalink($tutorial_id) . "' target='_blank' style='display:inline-block;background:#026447;color:white;padding:15px 30px;text-decoration:none;border-radius:5px;font-size:16px;'>View Tutorial</a></p>";

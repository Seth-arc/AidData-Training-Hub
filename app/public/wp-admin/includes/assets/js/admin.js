            ...
            return `
                ...
                <head>
                    ...
                    <style>
                        ...
                        .course-title { font-size: 2rem; color: #026447; margin-bottom: 1rem; }
                        ...
                        .meta-value { font-weight: bold; color: #026447; }
                        .course-description { color: #495965; line-height: 1.6; }
                        .section { margin-bottom: 2rem; }
                        .section-title { font-size: 1.25rem; color: #026447; margin-bottom: 1rem; }
                        .item-list { display: flex; flex-direction: column; gap: 0.5rem; }
                        .item { padding: 0.75rem; background: #f8f9fa; border-radius: 6px; }
                    </style>
                </head>
                <body>

<?php
/**
 * Template Name: AidData Tutorial Page Replica
 * Template Post Type: page
 *
 * Tutorial template based on the course page design
...
$aiddata_tutorial_course_id = 1507;
$aiddata_tutorial_destination = function_exists( 'aiddata_get_course_start_url' )
    ? aiddata_get_course_start_url( $aiddata_tutorial_course_id )
    : get_permalink( $aiddata_tutorial_course_id );

if ( ! $aiddata_tutorial_destination ) {
    $aiddata_tutorial_destination = home_url( '/' );
}

$aiddata_tutorial_enroll_url  = add_query_arg(
    array(
        'enroll-course' => $aiddata_tutorial_course_id,
        'redirect_to'   => $aiddata_tutorial_destination,
    ),
    home_url( '/' )
);
?>
...
<style>
    ...
    ::-webkit-scrollbar-thumb:hover {
        background: #024e37; /* Darker green for hover state */
    }
    ...
    .loading-text {
        ...
        * {
        ...
        .logo-icon {
            width: 32px;
            height: 32px;
            background: linear-gradient(135deg, #4CAF50 0%, #2E7D32 50%, #1a5f4f 100%);
            border-radius: 4px;
        }
        ...
        .hero {
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), 
                        url('http://localhost:10016/wp-content/themes/twentytwentyfour/assets/images/china_dashboard.png');
    ...
    <section class="hero">
        <div class="hero-content">
            <nav class="breadcrumb">
                ...
                <a href="#">Tutorials</a>
                <span>/</span>
                <span>Global Chinese Development Finance</span>
            </nav>
            
            <h1 class="tutorial-title">Global Chinese Development Finance</h1>
            <p class="tutorial-subtitle">Learn how to navigate and use AidData's Global China Development Finance (GCDF) dataset and dashboard.</p>
            
            <div class="tutorial-tags">
                <span class="tag">Tutorial</span>
                <span class="tag">Sovereign Finance</span>
    ...
    <main class="main-content">
        <div class="content-column">
            ...
            <div class="content-section">
                ...
                <div class="section-content">
                    ...
                    <p>Designed for researchers, students, and policy professionals who want to get the most out of AidData's comprehensive development finance database.</p>
                </div>
            </div>
                ...
                <div class="section-content">
                    <div class="learning-objectives-grid">
                        <div class="learning-card">
                            ...
                            <h4>Dataset Navigation</h4>
                            <p>Learn how to efficiently search and filter through AidData's extensive collection of development finance datasets.</p>
                        </div>
                        ...
                        <div class="learning-card">
                            ...
                            <p>Discover how to create interactive charts and maps using AidData's built-in visualization features.</p>
                        </div>
                        ...
                        <div class="learning-card">
                            ...
                            <h4>Data Export</h4>
                            <p>Master the process of exporting data in various formats for use in your own research and analysis.</p>
                        </div>
                        ...
                        <div class="learning-card">
                            ...
                            <p>Learn research best practices and tips for getting the most accurate and relevant results from your searches.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="section-content">
                    <div class="tutorial-step">
                        <div class="step-header">
                            <span class="step-title">Introduction to AidData's GCDF Dataset</span>
                            <div class="step-toggle">▼</div>
                        </div>
                        <div class="step-content">
                            <div class="step-details">
                                <p>Learn about AidData's Global Chinese Development Finance (GCDF) dataset and understand the scope and methodology behind tracking Chinese overseas development projects and financial flows.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tutorial-step">
                        <div class="step-header">
                            <span class="step-title">Navigating the Dashboard</span>
                            <div class="step-toggle">▼</div>
                        </div>
                        <div class="step-content">
                            <div class="step-details">
                                <p>Get familiar with the main dashboard interface, including the navigation menu, search functionality, and key sections for accessing datasets and tools.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tutorial-step">
                        <div class="step-header">
                            <span class="step-title">Searching and Filtering Data</span>
                            <div class="step-toggle">▼</div>
                        </div>
                        <div class="step-content">
                            <div class="step-details">
                                <p>Master the advanced search and filtering options to find exactly the data you need. Learn about geographic filters, time ranges, funding sources, and sector classifications.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tutorial-step">
                        <div class="step-header">
                            <span class="step-title">Exporting Your Results</span>
                            <div class="step-toggle">▼</div>
                        </div>
                        <div class="step-content">
                            <div class="step-details">
                                <p>Learn how to export your search results and visualizations in various formats including CSV, Excel, and image files for use in your own research and presentations.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <aside class="sidebar">
            <div class="cta-card">
                ...
                <a href="<?php echo esc_url( $aiddata_tutorial_enroll_url ); ?>" class="btn btn-primary">Start Tutorial</a>
            ...
            <div class="cta-card">
                <div style="margin-bottom: 1rem;">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/expert_insights.png" 
                ...
                <p style="font-size: 0.875rem; color: #555; line-height: 1.6; margin-bottom: 0.5rem;">
                    This tutorial includes footage from interviews with AidData researchers and analysts.
                </p>
                <p style="font-size: 0.875rem; color: #555; line-height: 1.6;">
                    More of the interview can be found <a href="https://www.aiddata.org/publications" target="_blank" style="color: #1a5f4f; text-decoration: underline; font-weight: 500;">here</a>.
                </p>
            </div>
        </aside>
    </main>
...
<!-- Enhanced Tutorial Loading System -->
<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/course-loading.js"></script>
</body>
</html>

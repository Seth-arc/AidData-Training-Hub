<?php
/**
 * Template Name: LifterLMS Course Template China
        ...
        <div class="course-header">
            <?php if ( is_singular( 'course' ) || is_singular( 'llms_course' ) ) : ?>
                ...
                ?>
                    ...
                    <?php else: ?>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/china_tutorial.PNG" alt="China Tutorial Dashboard" class="hero-image">
                <?php endif; ?>
                        
                            <div class="course-hero-content">
                                                                <h1 class="course-hero-title">China.AidData.org Dashboard</h1>                                
                                                                <div class="course-badges">                                    <span class="course-badge">Tutorial</span>                                    <span class="course-badge">Certificate</span>                                </div>                                <div style="display: flex; gap: 30px; justify-content: center; margin: 15px 0 25px; color: rgba(255, 255, 255, 0.85);">                                    <div style="display: flex; align-items: center; gap: 6px;">                                        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" style="min-width: 16px;">                                            <circle cx="12" cy="12" r="10"></circle>                                            <polyline points="12 6 12 12 16 14"></polyline>                                        </svg>                                        <span style="font-size: 14px; font-weight: 400;">9 mins</span>                                    </div>                                    <div style="display: flex; align-items: center; gap: 6px;">                                        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" style="min-width: 16px;">                                            <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>                                        </svg>                                        <span style="font-size: 14px; font-weight: 400;">All Levels</span>                                    </div>                                </div>
                                <button class="why-course-button" id="why-course-button">Why this Tutorial? <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
                                        ...
                                        <div class="drawer-grid">
                                            ...
                                            <div class="drawer-right">
                                                <div class="info-block" style="padding: 25px;">
                                                                                                        <h2 style="font-size: 20px; color: #026447; font-weight: 600; margin: 0 0 20px 0; font-family: 'Inter', sans-serif; text-align: left;">Making Complex Data Accessible</h2>                                                                                                        <p style="font-size: 14px;">The China.AidData.org dashboard is a powerful tool that provides access to the world's most comprehensive dataset on Chinese development finance. With over 13,000 projects worth more than $830 billion across 148 countries, the amount of data can be overwhelming. This tutorial breaks down the complexity into manageable, practical steps.</p>

                                                    <div class="scenario-examples" style="margin-bottom: 20px;">
                                                        <div class="scenario-card">
                                                                                                                        <div class="scenario-image" style="height: 200px; border-radius: 12px; margin-bottom: 16px; position: relative; overflow: hidden;">                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/researchers_tutorial.png" alt="Researchers using the China Dashboard" style="width: 100%; height: 100%; object-fit: cover;">                                                                <!-- Overlay gradient -->                                                                <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 50%; background: linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>                                                            </div>                                                            <h4 style="color: #026447; font-size: 18px; margin-bottom: 12px;">For Researchers</h4>                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Learn how to efficiently filter, analyze, and export data for your research. Whether you're studying global development patterns, conducting country-specific analysis, or tracking sectoral trends, this tutorial will show you how to leverage the dashboard's full capabilities for academic research.</p>
                                                        </div>
                                                        <div class="scenario-card">
                                                                                                                        <div class="scenario-image" style="height: 200px; border-radius: 12px; margin-bottom: 16px; position: relative; overflow: hidden;">                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/practitioners_tutorial.png" alt="Practitioners using the China Dashboard" style="width: 100%; height: 100%; object-fit: cover;">                                                                <!-- Overlay gradient -->                                                                <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 50%; background: linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>                                                            </div>                                                            <h4 style="color: #026447; font-size: 18px; margin-bottom: 12px;">For Practitioners</h4>                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Discover how to use the dashboard for practical applications in development finance. From identifying regional investment patterns to understanding project implementation timelines, you'll learn how to extract actionable insights for policy and practice.</p>
                                                        </div>
                                                    </div>
                    ...
                    <div class="tab-content" id="overview" style="display: block;">
                                            <div style="display: flex; flex-direction: column; gap: 25px; margin-bottom: 30px;">
                                                <!-- Video removed -->
                                                                                ...
                                                                                <div style="background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter', sans-serif; text-align: left;">Tutorial Description</h3>                                                    <p style="font-size: 14px; color: #333; line-height: 1.6; margin-bottom: 15px; font-family: 'Inter', sans-serif;">                                                        Get hands-on experience with AidData's premier tool for tracking Chinese development finance. This quick tutorial will show you how to navigate the dashboard, understand its features, and extract valuable insights about Chinese overseas development projects.                                                    </p>                                                </div>
                    ...
                    <div class="tab-content" id="curriculum" style="display: none;">
                        <div class="course-curriculum">
                            <div class="course-modules" style="margin-bottom: 40px;">
                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">1</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Getting Started</h3>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Quick overview of the dashboard layout and key features:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Understanding project cards</li>                                        <li style="margin-bottom: 4px;">• Navigating the map interface</li>                                        <li>• Basic search functionality</li>                                    </ul>                                </div>                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">2</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Advanced Search</h3>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Master the search and filter capabilities:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Using multiple filters simultaneously</li>                                        <li style="margin-bottom: 4px;">• Searching by project characteristics</li>                                        <li>• Understanding flow types and status</li>                                    </ul>                                </div>                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">3</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Data Analysis</h3>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Learn to analyze project data effectively:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Using the summary statistics panel</li>                                        <li style="margin-bottom: 4px;">• Interpreting project timelines</li>                                        <li>• Understanding commitment amounts</li>                                    </ul>                                </div>                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">4</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Export & Citation</h3>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Guidelines for using the data responsibly:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Downloading filtered datasets</li>                                        <li style="margin-bottom: 4px;">• Proper citation practices</li>                                        <li>• Accessing methodology docs</li>                                    </ul>                                </div>
                            </div>
                    ...
                    <div class="tab-content" id="instructor" style="display: none;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr; gap: 15px; margin-bottom: 15px;">
                            ...
                            <?php endforeach; ?>
                                        ...
                                        <div class="tab-content" id="enroll" style="display: none; background-color: transparent; border-radius: 8px; padding: 20px; border: none;">                                            <div style="display: flex; flex-direction: column; gap: 25px; max-width: 600px; margin: 0 auto;">
                                                        ...
                                                        <ul style="list-style-type: none; padding: 0; margin: 0 0 25px 0; font-family: 'Inter', sans-serif;">
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                                                                                        <strong style="font-weight: 600;">Full tutorial access</strong>                                                                    <span style="font-size: 13px; color: #666; margin-top: 2px;">No registration required</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#026447" stroke-width="2" style="margin-right: 15px; min-width: 20px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                                                                                        <strong style="font-weight: 600;">Downloadable resources</strong>                                                                    <span style="font-size: 13px; color: #666; margin-top: 2px;">Access to dashboard documentation</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#026447" stroke-width="2" style="margin-right: 15px; min-width: 20px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                                                                                        <strong style="font-weight: 600;">Interactive tutorials</strong>                                                                    <span style="font-size: 13px; color: #666; margin-top: 2px;">Step-by-step guidance for all features</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                                                                                        <strong style="font-weight: 600;">Completion Certificate</strong>                                                                    <span style="font-size: 13px; color: #666; margin-top: 2px;">                                                                        Recieve a downloadable and sharable AidData certificate if you successfully complete a short quiz                                                                    </span>
                                                                </span>
                                                            </li>
                                                        </ul>
            ...
            <div class="social-links">
                ...
                <a href="https://github.com/aiddata" target="_blank" rel="noopener noreferrer" aria-label="View our code on GitHub">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                                ...
                                <a href="https://www.instagram.com/aiddata?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram">                    <svg viewBox="0 0 24 24" fill="currentColor">                        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>                    </svg>                </a>
            </div>
        </div>

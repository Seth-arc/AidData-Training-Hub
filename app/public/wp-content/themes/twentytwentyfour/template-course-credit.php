<?php
/**
 * Template Name: LifterLMS Course Template Credit
                        ...
                        <div class="course-hero">
                            ...
                            <div class="course-video">
                                    <?php echo wp_oembed_get($video_embed); ?>
                                                                    ...
                                                                    <?php elseif ( has_post_thumbnail() ) : ?>                        <?php the_post_thumbnail( 'full', array('class' => 'hero-image') ); ?>                    <?php else: ?>                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/credit_shopper_zoomed.png" alt="Credit Shopper" class="hero-image">
                <?php endif; ?>
                        
                            <div class="course-hero-content">
                                                                <h1 class="course-hero-title">AidData Credit Shopper Tool</h1>                                
                                                                <div class="course-badges">                                    <span class="course-badge">Tool</span>                                    <span class="course-badge">Subscription</span>                                </div>

                                <button class="why-course-button" id="why-course-button">Why this Tool? <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
                                        ...
                                        <div class="drawer-grid">
                                            <div class="drawer-left">
                                                ...
                                                <div class="related-news" style="background: #f9f9f9; border-radius: 12px; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.08); padding: 25px;">
                                                    <h4 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 20px; border-bottom: 1px solid rgba(0, 0, 0, 0.05); padding-bottom: 10px;">Related Research</h4>
                                                    <div class="news-items">
                                                        <a href="https://www.aiddata.org/publications/belt-and-road-reboot" class="news-item" target="_blank" style="display: block; margin-bottom: 20px; background: white; border-radius: 8px; overflow: hidden; text-decoration: none; transition: all 0.3s ease;">
                                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Belt_and_Road_Reboot_Full_Report_Cover.png" alt="Belt and Road Reboot: Beijing's Bid to De-Risk Its Global Infrastructure Initiative" style="width: 100%; height: 160px; object-fit: cover;">
                                                            <div class="news-content" style="padding: 15px;">
                                                                <h5 style="margin: 0 0 8px 0; font-size: 16px; color: #026447; line-height: 1.4;">Belt and Road Reboot: Beijing's Bid to De-Risk Its Global Infrastructure Initiative</h5>
                                                                <p style="margin: 0 0 8px 0; font-size: 14px; color: #555; line-height: 1.5;">This comprehensive report provides myth-busting evidence about the nature, scale, and scope of China's overseas development program, analyzing over 20,000 projects worth $1.3 trillion.</p>
                                                                <span class="news-date" style="display: block; font-size: 12px; color: #666;">November 6, 2023</span>
                                                            </div>
                                                        </a>
                                                        <a href="https://www.aiddata.org/publications/aiddatas-geospatial-global-chinese-development-finance-dataset" class="news-item" target="_blank" style="display: block; background: white; border-radius: 8px; overflow: hidden; text-decoration: none; transition: all 0.3s ease;">
                                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Geo_GCDF_paper_cover.png" alt="AidData's Geospatial Global Chinese Development Finance Dataset" style="width: 100%; height: 160px; object-fit: cover;">
                                                            <div class="news-content" style="padding: 15px;">
                                                                <h5 style="margin: 0 0 8px 0; font-size: 16px; color: #026447; line-height: 1.4;">AidData's Geospatial Global Chinese Development Finance Dataset</h5>
                                                                <p style="margin: 0 0 8px 0; font-size: 14px; color: #555; line-height: 1.5;">This dataset provides geospatial features for 9,405 Chinese development projects across 148 countries, representing over $830 billion in loans and grants from 2000 to 2021.</p>
                                                                <span class="news-date" style="display: block; font-size: 12px; color: #666;">June 11, 2024</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="drawer-right">
                                                <div class="info-block" style="padding: 25px;">
                                                    <h2 style="font-size: 20px; color: #026447; font-weight: 600; margin: 0 0 20px 0; font-family: 'Inter', sans-serif; text-align: left;">About This Tool</h2>
                                                    <p style="font-size: 14px;">The Credit Shopper Tool is a sophisticated platform that leverages AidData's comprehensive development finance datasets to enable detailed comparison and analysis of financing options from various development finance institutions. This tool is designed to help development professionals make informed decisions by providing real-time comparisons, historical data analysis, and market trend insights.</p>
                                                    

                                                    <ul class="complexity-challenges" style="list-style: none; padding: 0; margin: 25px 0 30px 0; display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                                                        <li class="complexity-challenge" style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid rgba(2, 100, 71, 0.1);">
                                                            <div style="width: 100%; height: 120px; border-radius: 6px; margin-bottom: 15px; overflow: hidden;">
                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/development_professionals_tool.png" alt="Development Finance Professionals" style="width: 100%; height: 100%; object-fit: cover;">
                                                            </div>
                                                            <strong style="color: #026447; display: block; margin-bottom: 10px; font-size: 16px; font-weight: 500;">For Development Finance Professionals</strong>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0;">Compare financing options across multiple institutions, analyze historical trends, and generate detailed reports for stakeholders.</p>
                                                        </li>
                                                        <li class="complexity-challenge" style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid rgba(2, 100, 71, 0.1);">
                                                            <div style="width: 100%; height: 120px; border-radius: 6px; margin-bottom: 15px; overflow: hidden;">
                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/government_officials_tool.png" alt="Government Officials" style="width: 100%; height: 100%; object-fit: cover;">
                                                            </div>
                                                            <strong style="color: #026447; display: block; margin-bottom: 10px; font-size: 16px; font-weight: 500;">For Government Officials</strong>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0;">Evaluate different financing packages, assess debt sustainability implications, and make evidence-based financing decisions.</p>
                                                        </li>
                                                        <li class="complexity-challenge" style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid rgba(2, 100, 71, 0.1);">
                                                            <div style="width: 100%; height: 120px; border-radius: 6px; margin-bottom: 15px; overflow: hidden;">
                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/researchers_tool.png" alt="Researchers" style="width: 100%; height: 100%; object-fit: cover;">
                                                            </div>
                                                            <strong style="color: #026447; display: block; margin-bottom: 10px; font-size: 16px; font-weight: 500;">For Researchers</strong>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0;">Access comprehensive financing data, analyze regional and sectoral trends, and export data for academic research.</p>
                                                        </li>
                                                    </ul>

                                                    <h3 style="font-size: 18px; color: #026447; font-weight: 600; margin: 25px 0 15px 0; font-family: 'Inter', sans-serif;">Tool Components</h3>
                                                    <div class="scenario-examples" style="margin-bottom: 20px;">
                                                        <div class="scenario-card">
                                                            <h4 style="color: #026447; font-size: 16px; margin-bottom: 12px;">Credit Comparison Dashboard</h4>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Compare multiple financing options side by side with detailed breakdowns of terms, conditions, and requirements.</p>
                                                        </div>
                                                        <div class="scenario-card">
                                                            <h4 style="color: #026447; font-size: 16px; margin-bottom: 12px;">Financial Calculator Suite</h4>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Calculate and visualize different scenarios with interactive tools for loan terms, interest rates, and repayment schedules.</p>
                                                        </div>
                                                        <div class="scenario-card">
                                                            <h4 style="color: #026447; font-size: 16px; margin-bottom: 12px;">Market Analysis Tools</h4>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Access historical data and market trends to make informed decisions about financing options.</p>
                                                        </div>
                                                        <div class="scenario-card">
                                                            <h4 style="color: #026447; font-size: 16px; margin-bottom: 12px;">Report Generator</h4>
                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Create professional reports and presentations with customizable templates and export options.</p>
                                                        </div>
                                                    </div>

                                                    <div style="margin-top: 30px; padding: 20px; background: rgba(2, 100, 71, 0.05); border-radius: 12px;">
                                                        <h4 style="color: #026447; margin-top: 0; font-size: 18px;">Ready to Get Started?</h4>
                                                        <p style="margin-bottom: 0; font-size: 14px;">Explore the Credit Shopper Tool to make more informed borrowing decisions with comprehensive loan comparison tools and analytics. Whether you're a financial analyst, government official, or researcher, this tool will enhance your ability to evaluate financing options effectively.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <?php endif; ?>
                ...
                <div class="course-navigation">
                    <div class="course-tabs">
                        ...
                        <button class="tab-button" data-tab="developer">Developer</button>
                                        <button class="tab-button" data-tab="subscribe">Subscribe</button>
                    </div>
                    ...
                    <div class="tab-content" id="overview" style="display: block;">
                                ...
                                <div style="background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter', sans-serif; text-align: left;">Tool Description</h3>                                                    <p style="font-size: 14px; color: #333; line-height: 1.6; margin-bottom: 15px; font-family: 'Inter', sans-serif;">                                                        The AidData Credit Shopper Tool is an innovative platform designed to help government officials, development practitioners, and financial analysts compare financing options from various lenders. This interactive dashboard enables users to evaluate loan terms, interest rates, and repayment conditions across different creditors, facilitating more informed borrowing decisions.                                                    </p>                                                    <p style="font-size: 14px; color: #333; line-height: 1.6; margin-bottom: 0; font-family: 'Inter', sans-serif;">The tool combines data from multiple sources, including official development assistance records, commercial loan agreements, and export credit arrangements, providing comprehensive insights into the global development finance landscape.</p>
                                </div>                                                


                                                <div>
                                                    <h3 style="color: #026447; font-size: 20px; margin-bottom: 20px; font-family: 'Inter', sans-serif; text-align: left;">Key Tool Benefits</h3>
                                                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 15px;">
                                                                        <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                        <div style="display: flex; align-items: flex-start; gap: 10px;">                                            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#026447" stroke-width="2" style="min-width: 22px; margin-top: 3px;">                                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>                                                <polyline points="14 2 14 8 20 8"></polyline>                                                <line x1="16" y1="13" x2="8" y2="13"></line>                                                <line x1="16" y1="17" x2="8" y2="17"></line>                                                <polyline points="10 9 9 9 8 9"></polyline>                                            </svg>                                            <div>                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter', sans-serif;">Comprehensive Data</h4>                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter', sans-serif;">Access a rich database of financing options from bilateral, multilateral, and commercial creditors with detailed terms and conditions.</p>                                            </div>                                        </div>                                    </div>                                                                        <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                        <div style="display: flex; align-items: flex-start; gap: 10px;">                                            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#026447" stroke-width="2" style="min-width: 22px; margin-top: 3px;">                                                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>                                            </svg>                                            <div>                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter', sans-serif;">Side-by-Side Comparison</h4>                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter', sans-serif;">Easily compare financing packages across multiple dimensions including interest rates, grace periods, maturities, and hidden fees.</p>                                            </div>                                        </div>                                    </div>                                                                        <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                        <div style="display: flex; align-items: flex-start; gap: 10px;">                                            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#026447" stroke-width="2" style="min-width: 22px; margin-top: 3px;">                                                <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>                                            </svg>                                            <div>                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter', sans-serif;">Risk Assessment</h4>                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter', sans-serif;">Evaluate the long-term implications of different financing options with built-in analytical tools that highlight hidden risks and obligations.</p>                                            </div>                                        </div>                                    </div>                                                                        <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                        <div style="display: flex; align-items: flex-start; gap: 10px;">                                            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#026447" stroke-width="2" style="min-width: 22px; margin-top: 3px;">                                                <circle cx="12" cy="12" r="10"></circle>                                                <line x1="2" y1="12" x2="22" y2="12"></line>                                                <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path>                                            </svg>                                            <div>                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter', sans-serif;">Decision Support</h4>                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter', sans-serif;">Generate detailed reports and visualizations to support evidence-based decision-making and negotiations with potential creditors.</p>                                            </div>                                        </div>                                    </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-content" id="features" style="display: none;">
                        <div class="course-curriculum">
                            <div class="course-modules" style="margin-bottom: 40px;">
                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">1</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Loan Comparison Engine</h3>                                        <span style="margin-left: auto; color: #666; font-size: 14px;">Core Feature</span>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Advanced comparison functionality for detailed loan analysis:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Side-by-side financial term comparison across multiple lenders</li>                                        <li style="margin-bottom: 4px;">• Interactive visualizations of repayment schedules</li>                                        <li>• Total cost analysis including all fees and contingencies</li>                                    </ul>                                </div>                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">2</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Risk Assessment Tools</h3>                                        <span style="margin-left: auto; color: #666; font-size: 14px;">Analytics</span>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Sophisticated risk analysis features:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Debt sustainability analysis with multiple scenarios</li>                                        <li style="margin-bottom: 4px;">• Automatic flagging of concerning contract terms</li>                                        <li>• Currency risk and commodity price volatility modeling</li>                                    </ul>                                </div>                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">3</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Reporting & Export</h3>                                        <span style="margin-left: auto; color: #666; font-size: 14px;">Documentation</span>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Comprehensive reporting capabilities:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Customizable reports for stakeholder presentations</li>                                        <li style="margin-bottom: 4px;">• Data export in multiple formats (Excel, PDF, CSV)</li>                                        <li>• Detailed term sheets with highlighted differentiators</li>                                    </ul>                                </div>                                                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">                                    <div style="display: flex; align-items: center; margin-bottom: 12px;">                                        <div style="background: rgba(2, 100, 71, 0.1); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; margin-right: 12px;">                                            <span style="color: #026447; font-weight: 500;">4</span>                                        </div>                                        <h3 style="color: #026447; font-size: 20px; margin: 0; font-family: 'Inter', sans-serif;">Collaborative Platform</h3>                                        <span style="margin-left: auto; color: #666; font-size: 14px;">Team Access</span>                                    </div>                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter', sans-serif;">Seamless team collaboration features:</p>                                    <ul style="list-style: none; padding-left: 0; margin-top: 8px; font-size: 14px; color: #555;">                                        <li style="margin-bottom: 4px;">• Multi-user access with customizable permissions</li>                                        <li style="margin-bottom: 4px;">• Shared comments and annotations on financing options</li>                                        <li>• Version history and decision tracking capabilities</li>                                    </ul>                                </div>
                            </div>
                    ...
                    <div class="tab-content" id="developer" style="display: none;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr; gap: 15px; margin-bottom: 15px;">
                            ...
                            <?php endforeach; ?>
                                        ...
                                        <div class="tab-content" id="subscribe" style="display: none; background-color: transparent; border-radius: 8px; padding: 20px; border: none;">
                                            <div style="display: flex; flex-direction: column; gap: 25px; max-width: 600px; margin: 0 auto;">
                                                ...
                                                <div style="background-color: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); overflow: hidden; border: 1px solid rgba(0, 0, 0, 0.04);">
                                                    ...
                                                    <div style="background-color: #026447; padding: 25px; color: white; text-align: center;">
                                                        ...
                                                        <div style="display: flex; justify-content: center; align-items: baseline; gap: 5px;">
                                                            <span style="font-size: 28px; font-weight: 700; line-height: 1;">$20</span><span style="font-size: 18px; font-weight: 500; margin-left: 5px; opacity: 0.9;">p/m</span>
                                                        </div>
                                                    </div>
                                                    
                                                    <!-- Course features -->
                                                    <div style="padding: 30px;">
                                                        <h4 style="margin: 0 0 20px 0; font-size: 18px; color: #333; font-family: 'Inter', sans-serif; font-weight: 600; border-bottom: 1px solid rgba(0, 0, 0, 0.08); padding-bottom: 15px;">Tool Features</h4>
                                                        ...
                                                        <ul style="list-style-type: none; padding: 0; margin: 0 0 25px 0; font-family: 'Inter', sans-serif;">
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Comprehensive Loan Data Access</strong>
                                                                    <span style="font-size: 15px; color: #666; margin-top: 2px;">Compare financing options from multiple lenders</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#026447" stroke-width="2" style="margin-right: 15px; min-width: 20px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Interactive Analysis Tools</strong>
                                                                    <span style="font-size: 15px; color: #666; margin-top: 2px;">Risk assessment and side-by-side comparisons</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Customizable Reports & Exports</strong>
                                                                    <span style="font-size: 15px; color: #666; margin-top: 2px;">Generate detailed analysis for stakeholders</span>
                                                                </span>
                                                            </li>

                                                        </ul>
                                                        
                                                                                                                 <a href="#" target="_blank" rel="noopener noreferrer" class="enroll-button" style="display: inline-block; background-color: #026447; color: #fff; padding: 16px 20px; font-size: 16px; font-weight: 600; text-align: center; border-radius: 6px; border: none; cursor: pointer; text-decoration: none; margin-top: 10px; margin-bottom: 5px; transition: all 0.3s ease; width: 100%; font-family: 'Inter', sans-serif; box-shadow: 0 4px 6px rgba(2, 100, 71, 0.2);">Subscribe Now</a>
                                                ...
                                                <div style="background-color: #f8f9fa; padding: 25px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05); margin-top: 5px;">
                                                    <div style="display: flex; align-items: flex-start;">
                                                        <div>
                                                            <h5 style="color: #026447; font-size: 16px; margin: 0 0 10px 0; font-family: 'Inter', sans-serif; font-weight: 600;">Institutional Access Available</h5>
                                                            <p style="font-size: 15px; color: #555; line-height: 1.6; margin-bottom: 15px; font-family: 'Inter', sans-serif;">Organizations can request multi-user licenses with additional features including collaborative workspaces and advanced analytics for decision-making teams.</p>
                                                            <a href="#" id="institutional-inquiry-btn" style="color: #026447; font-size: 15px; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; font-family: 'Inter', sans-serif;">
...
<script>
    ...
    window.addEventListener('load', function() {
        ...
        if (whyCourseButton && infoDrawer && drawerClose) {
            // Open drawer when clicking the "Why this Tutorial?" button
...
<script>
    ...
    window.addEventListener('load', function() {
        ...
        if (whyCourseButton && infoDrawer && drawerClose) {
            // Open drawer when clicking the "Why this Tutorial?" button            whyCourseButton.addEventListener('click', function() {
                infoDrawer.classList.add('active');
                // Prevent scrolling on body when drawer is open
                document.body.style.overflow = 'hidden';
            });
...
<div id="institutional-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; align-items: center; justify-content: center; font-family: 'Inter', sans-serif;">
    <div style="background-color: white; width: 90%; max-width: 550px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.2); position: relative; max-height: 90vh; overflow-y: auto;">
        <button id="close-institutional-modal" style="position: absolute; top: 15px; right: 15px; background: none; border: none; cursor: pointer; font-size: 24px; color: #666;">&times;</button>
        
        <div style="padding: 30px;">
            <h3 style="color: #026447; font-size: 22px; margin: 0 0 20px 0; font-family: 'Inter', sans-serif; font-weight: 600;">Request Institutional Access</h3>
            <p style="color: #555; margin-bottom: 25px; font-size: 15px; line-height: 1.5;">Complete the form below to request multi-user access for your organization. Institutional accounts include collaborative workspaces, advanced analytics, and team management features.</p>
            
            <form id="institutional-form">
                <div style="margin-bottom: 15px;">
                    <label for="inst-organization-name" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Organization Name *</label>
                    <input type="text" id="inst-organization-name" name="inst-organization-name" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif;">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="inst-contact-name" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Contact Person *</label>
                    <input type="text" id="inst-contact-name" name="inst-contact-name" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif;">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="inst-email" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Email Address *</label>
                    <input type="email" id="inst-email" name="inst-email" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif;">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="inst-phone" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Phone Number</label>
                    <input type="tel" id="inst-phone" name="inst-phone" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif;">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="inst-number-users" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Number of Users *</label>
                    <input type="number" id="inst-number-users" name="inst-number-users" min="2" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif;">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="inst-organization-type" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Organization Type *</label>
                    <select id="inst-organization-type" name="inst-organization-type" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif; background-color: white;">
                        <option value="">Please select</option>
                        <option value="Government Agency">Government Agency</option>
                ...
                <div style="margin-bottom: 25px;">
                    <label for="inst-requirements" style="display: block; margin-bottom: 5px; font-weight: 500; color: #333;">Specific Requirements *</label>
                    <textarea id="inst-requirements" name="inst-requirements" rows="4" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: 'Inter', sans-serif;" placeholder="Please describe your organization's needs and how you intend to use this tool."></textarea>
                </div>
                
                <button type="submit" style="background-color: #026447; color: white; border: none; border-radius: 6px; padding: 12px 20px; font-family: 'Inter', sans-serif; font-weight: 600; cursor: pointer; width: 100%;">Submit Request</button>
            </form>
        </div>
    </div>
</div>
...
// Institutional access modal functionality
ready(function() {
    const institutionalBtn = document.getElementById('institutional-inquiry-btn');
    const institutionalModal = document.getElementById('institutional-modal');
    const closeInstitutionalBtn = document.getElementById('close-institutional-modal');
    const institutionalForm = document.getElementById('institutional-form');
    
    if (institutionalBtn && institutionalModal) {
        // Open modal when clicking the institutional access button
        institutionalBtn.addEventListener('click', function(e) {
            e.preventDefault();
            institutionalModal.style.display = 'flex';
            document.body.style.overflow = 'hidden'; // Prevent background scrolling
        });
        
        // Close modal when clicking the close button
        if (closeInstitutionalBtn) {
            closeInstitutionalBtn.addEventListener('click', function() {
                institutionalModal.style.display = 'none';
                document.body.style.overflow = ''; // Restore scrolling
            });
        }
        
        // Close modal when clicking outside the modal content
        institutionalModal.addEventListener('click', function(e) {
            if (e.target === institutionalModal) {
                institutionalModal.style.display = 'none';
                document.body.style.overflow = ''; // Restore scrolling
            }
        });
        ...
        if (institutionalForm) {
            institutionalForm.addEventListener('submit', function(e) {
                e.preventDefault();
                
                // Get form data
                const orgName = document.getElementById('inst-organization-name').value;
                const contactName = document.getElementById('inst-contact-name').value;
                const email = document.getElementById('inst-email').value;
                const phone = document.getElementById('inst-phone').value;
                const numUsers = document.getElementById('inst-number-users').value;
                const orgType = document.getElementById('inst-organization-type').value;
                const requirements = document.getElementById('inst-requirements').value;
...
`;
                ...
                // Create subject line
                const subjectLine = `Institutional Access Request - ${orgName} (${numUsers} users)`;
                
                // Create mailto link with form data
                const mailtoLink = `mailto:access@aiddata.org?subject=${encodeURIComponent(subjectLine)}&body=${encodeURIComponent(emailBody)}`;
                
                // Open email client with pre-filled email
                window.location.href = mailtoLink;
                
                // Show confirmation message
                alert('Thank you for your inquiry! Your default email client will now open with the institutional access request details.');

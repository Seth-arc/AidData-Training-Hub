...
<style>
    ...
    .section-heading { font-size: 1.25rem; font-weight: 700; color: #1a5f4f; margin-bottom: 1rem; border-bottom: 2px solid #e6e6e6; padding-bottom: .6rem; }
    ...
    ::-webkit-scrollbar-thumb:hover { background: #024e37; }
...
<main class="interview-main">
    ...
    <aside class="sidebar">
        <div class="content-card" style="margin-bottom: 1rem;">
            ...
            <p style="font-size:.9rem;color:#6b7280;">To learn more, read the report <a href="https://docs.aiddata.org/reports/harboring-global-ambitions/Harboring_Global_Ambitions.html" target="_blank" rel="noopener noreferrer" style="color:#1a5f4f; text-decoration: underline;">here</a>.</p>
        </div>
    </aside>
</main>

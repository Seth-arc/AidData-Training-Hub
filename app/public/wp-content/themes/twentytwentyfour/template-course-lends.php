<?php
/**
 * Template Name: LifterLMS Course Template Lends
                        ...
                        <div class="course-hero">
                            ...
                            <div class="course-video">
                                    <?php echo wp_oembed_get($video_embed); ?>
                                                                    ...
                                                                    <?php elseif ( has_post_thumbnail() ) : ?>                        <?php the_post_thumbnail( 'full', array('class' => 'hero-image') ); ?>                    <?php else: ?>                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/china_lends.png" alt="How China Lends" class="hero-image">
                <?php endif; ?>
                        
                            <div class="course-hero-content">
                                                                <h1 class="course-hero-title">How China Lends Dashboard</h1>                                
                                                ...
                                                <div class="info-block" style="padding: 25px;">
                                                    ...
                                                    <div class="scenario-examples" style="margin-bottom: 20px;">
                                                        <div class="scenario-card">
                                                                                                                        <div class="scenario-image" style="height: 200px; border-radius: 12px; margin-bottom: 16px; position: relative; overflow: hidden;">                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/researchers_tutorial.png" alt="Chinese Loan Contracts" style="width: 100%; height: 100%; object-fit: cover;">                                                                <!-- Overlay gradient -->                                                                <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 50%; background: linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>                                                            </div>                                                            <h4 style="color: #026447; font-size: 18px; margin-bottom: 12px;">For Researchers</h4>                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Access 100 Chinese loan contracts with 24 low- and middle-income countries across Africa, Latin America, Asia-Pacific, and Eastern Europe. This unprecedented dataset allows researchers to analyze the legal terms of China's international lending arrangements and their implications for sovereign debt.</p>
                                                        </div>
                                                        <div class="scenario-card">
                                                                                                                        <div class="scenario-image" style="height: 200px; border-radius: 12px; margin-bottom: 16px; position: relative; overflow: hidden;">                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/practitioners_tutorial.png" alt="Contract Comparison Tools" style="width: 100%; height: 100%; object-fit: cover;">                                                                <!-- Overlay gradient -->                                                                <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 50%; background: linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>                                                            </div>                                                            <h4 style="color: #026447; font-size: 18px; margin-bottom: 12px;">For Practitioners</h4>                                                            <p style="font-size: 14px; color: #555; line-height: 1.5;">Compare Chinese contracts with those of other major lenders. The database includes 142 benchmark contracts from 28 other creditors, including both OECD and non-OECD lenders, enabling meaningful comparisons of lending terms and practices in international development finance.</p>
                                                        </div>
                                                    </div>
                    ...
                    <div class="tab-content" id="overview" style="display: block;">
                                ...
                                <div style="background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05); margin-bottom: 20px;">
                                    <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 15px;">
                                        ...
                                        <a href="https://www.ifw-kiel.de/institute/research-centers/" target="_blank" rel="noopener noreferrer" style="flex: 1; min-width: 120px; display: flex; justify-content: center; align-items: center; padding: 10px; text-decoration: none;">
                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/IfW_Logo_master_en_RGB-lowres.png" alt="Kiel Institute for the World Economy" style="max-height: 50px; max-width: 100%; object-fit: contain; filter: grayscale(20%);">
                                        </a>
                                        <a href="https://www.piie.com" target="_blank" rel="noopener noreferrer" style="flex: 1; min-width: 120px; display: flex; justify-content: center; align-items: center; padding: 10px; text-decoration: none;">
                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/piie-logo.png" alt="Peterson Institute for International Economics" style="max-height: 50px; max-width: 100%; object-fit: contain; filter: grayscale(20%);">
                                        </a>
                                    </div>
                                </div>

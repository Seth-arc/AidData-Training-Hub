<?php
/**
 * Template Name: LifterLMS Course Template
...
// Include the custom LMS header from front-page.php
?>
...
<?php
// Don't use get_header() since we're including the custom header above
// get_header();
        ...
        <div class="course-header">
            <?php if ( is_singular( 'course' ) || is_singular( 'llms_course' ) ) : ?>
                ...
                ?>
                    ...
                    <?php else: ?>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/global_finance.png" alt="Global Finance" class="hero-image">
                <?php endif; ?>
                                                ...
                                                <div class="related-news">
                                                    ...
                                                    <div class="news-items">
                                                        <a href="https://www.aiddata.org/blog/aiddata-and-rappler-data-journalism-course-explores-chinas-influence-on-global-development" class="news-item" target="_blank">
                                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/development_data_detectives.jpg" alt="Data journalism training in the Philippines">
                                                            <div class="news-content">
                                                                <h5>AidData and Rappler data journalism course explores China's influence on global development</h5>
                                                                <p>The training equipped practicing journalists with critical tools for analyzing economic and financial data to uncover trends in foreign funding.</p>
                                                                <span class="news-date">February 6, 2025</span>
                            </div>
                                                        </a>
                                                        <a href="https://www.aiddata.org/blog/hands-on-training-empowers-journalists-in-pakistan-for-data-driven-reporting" class="news-item" target="_blank">
                                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/data_journalism_pakistan.jpg" alt="Training session for journalists in Pakistan">
                                                            <div class="news-content">
                                                                <h5>Hands-on training empowers journalists in Pakistan for data-driven reporting</h5>
                                                                <p>The AidData-led training responds to the media's need for better data and evidence to understand how foreign lending and government economic policies are impacting citizens.</p>
                                                                <span class="news-date">January 30, 2023</span>
                                </div>
                                                        </a>
                        </div>
                    </div>
                                                
                                                <div class="contact-section" style="background: #f9f9f9; border-radius: 12px; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.08); padding: 25px; margin-top: 30px;">
                                                    ...
                                                    <div class="contact-person" style="display: flex; align-items: center; gap: 20px;">
                                                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/sethu_nguna.png" alt="Course Instructor" class="contact-avatar" style="width: 80px; height: 80px; border-radius: 50%; border: 3px solid #fff; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);">
                                                        <div class="contact-details">
                                                            ...
                                                            <p style="margin: 0; font-size: 13px; line-height: 1.5;">
                                                                ...
                                                                <a href="mailto:training@aiddata.org" style="color: #026447; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; font-size: 12px;">
                                                ...
                                                <div class="info-block" style="padding: 25px;">
                                                    ...
                                                    <div class="scenario-examples" style="margin-bottom: 0;">
                                                        <div class="scenario-card">
                                                            <div class="scenario-image">
                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/data-journalism.jpg" alt="Data Journalism in Practice">
                                </div>
                                                            <h4>Data-Driven Journalism</h4>
                                                            <p>Learn to craft compelling narratives from complex financial data. Develop the skills to uncover and communicate important stories about development finance that drive transparency and accountability.</p>
                                </div>
                                                        <div class="scenario-card">
                                                            <div class="scenario-image">
                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/data-analysis.jpg" alt="Data Analysis and Visualization">
                            </div>
                                                            <h4>Evidence-Based Analysis</h4>
                                                            <p>Master the tools and techniques needed to analyze development finance data, create impactful visualizations, and transform raw data into actionable insights.</p>
                    </div>
                                                    </div>
                                                    ...
                                                    <div class="drawer-footer" style="margin-top: 10px; padding-top: 0; border-top: none;">
                                                        ...
                                                        <div class="scenario-examples">
                                                            <div class="scenario-card">
                                                                <div class="scenario-image">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/hands-on-learning.png" alt="Hands-on Learning">
                                                                </div>
                                                                <h4>Hands-on Learning</h4>
                                                                <p>Work with real datasets and case studies from AidData's extensive research, applying analytical tools and techniques in practical scenarios.</p>
                                                            </div>
                                                            <div class="scenario-card">
                                                                <div class="scenario-image">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/expert-guidance.png" alt="Expert Guidance">
                                                                </div>
                                                                <h4>Expert Guidance</h4>
                                                                <p>Learn from experienced professionals in development finance, data analytics, and communications who bring both academic expertise and practical field experience.</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <p>Join professionals from around the world in mastering the fundamentals of development finance. Whether you're a journalist, researcher, or development practitioner, this course will equip you with the skills needed to understand and communicate about global development finance effectively.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-content" id="instructor" style="display: none;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr; gap: 15px; margin-bottom: 15px;">
                            ...
                            $instructors = [
                                [
                                    'name' => 'Alex Wooley',
                                    'title' => 'Director, Partnerships and Communications',
                                    'bio' => 'Alex leads AidData\'s communications and partnerships, bringing extensive experience in global development. His expertise helps participants understand the complexities of development finance from both communications and strategic partnership perspectives.',
                                    'avatar' => '',
                                    'image' => 'alex_wooley.jpg'
                                ],
                                [
                                    'name' => 'John Custer',
                                ...
                                [
                                    'name' => 'Sethu Nguna',
                                    'title' => 'Manager, Training & Instructional Design',
                                    'bio' => 'Sethu brings expertise in designing effective learning experiences for development professionals. Her experience in instructional design ensures that course participants gain practical, applicable skills in development finance data analysis and reporting.',
                                    'avatar' => '',
                                    'image' => 'sethu_nguna.png'
                                ]
                            ];
                                                        ...
                                                        <ul style="list-style-type: none; padding: 0; margin: 0 0 25px 0; font-family: 'Inter', sans-serif;">
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Full course access for 6 months</strong>
                                                                    <span style="font-size: 15px; color: #666; margin-top: 2px;">Complete the course at your own pace</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#026447" stroke-width="2" style="margin-right: 15px; min-width: 20px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Instructor feedback and support</strong>
                                                                    <span style="font-size: 15px; color: #666; margin-top: 2px;">Get guidance from industry experts</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px; border-bottom: 1px solid rgba(0, 0, 0, 0.04);">
                                                                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#026447" stroke-width="2" style="margin-right: 15px; min-width: 20px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Professional Capstone Project</strong>
                                                                    <span style="font-size: 15px; color: #666; margin-top: 2px;">Apply your skills to a real-world challenge</span>
                                                                </span>
                                                            </li>
                                                            <li style="padding: 12px 0; display: flex; align-items: center; color: #444; font-size: 15px;">
                                                                ...
                                                                <span style="display: flex; flex-direction: column;">
                                                                    <strong style="font-weight: 600; font-size: 15px;">Digital badge upon completion</strong>

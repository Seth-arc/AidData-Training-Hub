        ...
        <div class="featured-grid">
            ...
            <div class="featured-course" data-type="course">
                ...
                <div class="course-actions">
                    <button class="primary-button start-learning" data-course="http://localhost:10016/t-h/navigating-global-development-finance/">Start Learning</button>
            ...
            <div class="featured-course" data-type="tutorial">
                ...
                <div class="course-actions">
                    <button class="primary-button start-learning" data-course="http://localhost:10016/t-h/china-aiddata-dashboard/">Start Tutorial</button>
                ...
                <div class="course-preview">
                    ...
                    <div class="preview-overlay">
                        <div class="preview-content">
                            ...
                            <p>An introduction to AidData's pioneering geospatial impact evaluation (GIE) methodology for evaluating development interventions using satellite data.</p>
                            <div class="course-stats">
                                <span class="stat">
                                    <svg viewBox="0 0 24 24" width="16" height="16">
                                        <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2"/>
            ...
            <!-- Course 6: How China Lends Dashboard Tutorial -->
            <div class="featured-course" data-type="tutorial">
                <div class="course-preview">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/china_lends.png" alt="How China Lends Dashboard Tutorial" class="preview-image">
                    <div class="preview-overlay">
                        <div class="preview-content">
                            ...
                            <p>Learn to navigate the How China Lends and Collateralizes Dashboard to analyze Chinese loan contract terms, conditions, and patterns across countries and sectors.</p>
                            <div class="course-stats">
                                <span class="stat">
                                    <svg viewBox="0 0 24 24" width="16" height="16">
                                        <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2"/>
                ...
                <div class="course-actions">
                    <button class="primary-button start-learning" data-course="courses/how-china-lends-tutorial/">Start Tutorial</button>
                    <button class="trailer-button" data-video="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/videos/china_lends_preview.mp4">
                        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"/>
                            <polygon points="10 8 16 12 10 16" fill="currentColor"/>
                        </svg>
                    ...
                    <button class="secondary-button" data-modal="howchinalendsInfo">Info</button>
                </div>
            </div>
            ...
            <div class="featured-course" data-type="interview">
                ...
                <div class="course-actions">
                    <button class="primary-button start-learning" data-course="http://localhost:10016/t-h/harboring-global-ambitionss/">Watch Interview</button>
                    <button class="secondary-button" data-modal="harboringGlobalAmbitionsInterviewInfo">Info</button>
                </div>
            </div>
            ...
            <div class="featured-course" data-type="interview">
                ...
                <div class="course-actions">
                    <button class="primary-button start-learning" data-course="/interviews/">Watch Interview</button>
                    <button class="secondary-button" data-modal="listeningToLeadersInfo">Info</button>
                </div>
            </div>
    ...
    <div class="info-modal" id="howchinalendsInfo">
        <div class="info-container">
            ...
            <div class="info-content">
                ...
                <div class="info-description">
                    <h4>About this Tutorial</h4>
                    <p>Learn to navigate the How China Lends and Collateralizes Dashboard to analyze Chinese loan contract terms, conditions, and patterns across countries and sectors. This specialized tutorial provides detailed guidance on exploring the unique dataset of Chinese loan contracts and understanding their implications for global development finance.</p>
                    
                    <h4>What You'll Learn</h4>
                    <ul class="learning-objectives">
                        <li>How to use the dashboard interface to access detailed contract information</li>
                        <li>Methods for analyzing and comparing key contract terms across countries</li>
                        <li>Techniques for identifying patterns in lending terms and conditions</li>
                        <li>Ways to visualize contract data for different sectors and regions</li>
                        <li>Best practices for interpreting contract terms and their implications</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="notification-list">
                ...
                if (is_user_logged_in()) {
                    ...
                    if (!empty($notifications) && is_array($notifications)) {
                        ...
                        // Default notifications if none found in database
                        ?>
                    ...
                    // Default notification items for demo
                    ?>
...
<!-- Enhanced Course Loading System -->
<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/course-loading.js"></script>

<!-- Page Transitions Enhancement -->
<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/page-transitions.js"></script>

        ...
        <div class="course-header">
            <?php if ( is_singular( 'course' ) || is_singular( 'llms_course' ) ) : ?>
                ...
                ?>
                    ...
                    <?php else: ?>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/port_project.png" alt="Port Development Project" class="hero-image">
                <?php endif; ?>
                ...
                <div class="course-navigation">
                    ...
                    <div class="tab-content" id="curriculum" style="display: none;">
                        <div class="course-curriculum">
                            ...
                            <div class="module-timeline" style="position: relative; padding-left: 40px; margin-left: 20px; margin-bottom: 40px;">
                                <!-- Timeline connector -->
                                <div style="position: absolute; top: 35px; bottom: 0; left: 29px; width: 3px; background: linear-gradient(to bottom, #026447 0%, #026447 96%, transparent 96%, transparent 100%); z-index: 1;"></div>
                                
                                <!-- Module 1: Overview -->
                                <div class="module-item" style="position: relative; margin-bottom: 35px; background-color: white; padding: 25px; border-radius: 12px; border: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.04);">
                                    <!-- Module number marker -->
                                    <div style="position: absolute; left: -40px; top: 22px; width: 30px; height: 30px; background-color: #026447; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; z-index: 2; border: 3px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">1</div>
                                    
                                    <div style="display: flex; align-items: flex-start; gap: 15px;">
                                        <div style="background-color: rgba(2, 100, 71, 0.1); padding: 12px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                            <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#026447" stroke-width="2">
                                                <circle cx="12" cy="12" r="10"></circle>
                                ...
                                <!-- Module 2: Review Offers -->
                                <div class="module-item" style="position: relative; margin-bottom: 35px; background-color: white; padding: 25px; border-radius: 12px; border: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.04);">
                                    <div style="position: absolute; left: -40px; top: 22px; width: 30px; height: 30px; background-color: #026447; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; z-index: 2; border: 3px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">2</div>
                                ...
                                <!-- Module 3: Compare Terms -->
                                <div class="module-item" style="position: relative; margin-bottom: 35px; background-color: white; padding: 25px; border-radius: 12px; border: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.04);">
                                    <div style="position: absolute; left: -40px; top: 22px; width: 30px; height: 30px; background-color: #026447; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; z-index: 2; border: 3px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">3</div>
                                ...
                                <div class="module-item" style="position: relative; margin-bottom: 35px; background-color: white; padding: 25px; border-radius: 12px; border: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.04);">
                                    <div style="position: absolute; left: -40px; top: 22px; width: 30px; height: 30px; background-color: #026447; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; z-index: 2; border: 3px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">4</div>
                                ...
                                <div class="module-item" style="position: relative; margin-bottom: 35px; background-color: white; padding: 25px; border-radius: 12px; border: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.04);">
                                    <div style="position: absolute; left: -40px; top: 22px; width: 30px; height: 30px; background-color: #026447; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; z-index: 2; border: 3px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">5</div>
                                ...
                                <!-- Module 6: Make Decision (Final) -->
                                <div class="module-item" style="position: relative; margin-bottom: 35px; background-color: #f0f8f5; padding: 25px; border-radius: 12px; border: 1px solid rgba(2, 100, 71, 0.15); transition: all 0.3s ease; box-shadow: 0 5px 15px rgba(2, 100, 71, 0.08);">
                                    <div style="position: absolute; left: -40px; top: 22px; width: 30px; height: 30px; background-color: #026447; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; z-index: 2; border: 3px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">6</div>
                                    
                                    <div style="display: flex; align-items: flex-start; gap: 15px;">
                                        <div style="background-color: rgba(2, 100, 71, 0.2); padding: 12px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                            <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="#026447" stroke-width="2">
                                                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                                <polyline points="22 4 12 14.01 9 11.01"></polyline>
                                            </svg>
                ...
                'image' => 'asad_sami.png'
                            ...
                            <?php endforeach; ?>
                                        ...
                                        <div class="tab-content" id="enroll" style="display: none; background-color: transparent; border-radius: 8px; padding: 20px; border: none;">
                                            <div style="display: flex; flex-direction: column; gap: 25px; max-width: 900px; margin: 0 auto;">
                                                <!-- Pricing card -->
                                                <div style="background-color: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); overflow: hidden; border: 1px solid rgba(0, 0, 0, 0.04);">
                                                    ...
                                                    <div style="background-color: #026447; padding: 25px; color: white; text-align: center;">
                                                        <div style="display: flex; justify-content: center; align-items: baseline; gap: 5px;">
                                                            <span style="font-size: 36px; font-weight: 700; line-height: 1;">$1,250</span>
                                                        </div>
                                                    </div>

        ...
        <aside class="sidebar">
            ...
            <div class="cta-card">
                ...
                <p style="font-size: 0.875rem; color: #555; line-height: 1.6; margin-bottom: 0.5rem;">
                    This tutorial includes footage from the Seeing Development from Above interview with Jacob Hall and Kunwar Singh.<br><br>Watch the interview <a href="https://www.aiddata.org/publications" target="_blank" style="color: #1a5f4f; text-decoration: underline; font-weight: 500;">here</a>.
                </p>
            </div>
        </aside>
    </main>

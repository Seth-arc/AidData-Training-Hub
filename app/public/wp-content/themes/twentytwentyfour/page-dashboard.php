 ...
 * Description: User dashboard page for AidData LMS with front-page styling
 *
 * @package WordPress
...
<style>
    ...
    * {
    ...
    .dashboard-hero {
        margin-top: 0;
        padding: calc(90px + 0.5rem) 2rem 4rem; /* Keep hero flush with fixed header */
        position: relative;
        overflow: hidden;
        flex-shrink: 0;
    ...
    @media (max-width: 1024px) {
        ...
        .dashboard-hero {
            padding: calc(80px + 0.5rem) 2rem 3rem; /* Keep hero attached to header */
        }
    ...
    @media (max-width: 768px) {
        ...
        .dashboard-hero {
            padding: calc(70px + 0.5rem) 1.5rem 2.5rem; /* Keep hero attached to header */
        }
    ...
    @media (max-width: 480px) {
        ...
        .dashboard-hero {
            padding: calc(60px + 0.5rem) 1rem 2rem; /* Keep hero attached to header */
        }
                   ...
                   <div class="dashboard-section">
                       ...
                       <div class="progress-item">
                           ...
                           <div class="progress-actions">
                               <button class="continue-btn" data-course="http://localhost:10016/t-h/navigating-global-development-finance/">
                                   Continue
                               </button>
                           </div>
                       </div>

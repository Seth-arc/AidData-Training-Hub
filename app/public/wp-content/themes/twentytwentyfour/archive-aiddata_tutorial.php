 ...
 * Description: Archive page for AidData tutorials
 *
 * @package WordPress
    ...
    <div class="archive-hero">
        <div class="archive-hero-content">
            ...
            <p class="archive-description">
                Step-by-step guided learning experiences to help you master essential tools and concepts in development finance and data analysis.
            </p>
        </div>
    </div>
    ...
    <div class="main-content">
        <?php if (have_posts()) : ?>
            <div class="tutorials-grid">
                <?php while (have_posts()) : the_post(); 
                    $tutorial_duration = get_post_meta(get_the_ID(), '_tutorial_duration', true);
                    $tutorial_difficulty = get_post_meta(get_the_ID(), '_tutorial_difficulty', true);
                    $tutorial_category = get_post_meta(get_the_ID(), '_tutorial_category', true);
                ?>
                    <article class="tutorial-card">
                        <div class="tutorial-image">
                            ...
                            <?php else : ?>
                                <svg class="tutorial-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                </svg>
                            <?php endif; ?>
                            <?php if ($tutorial_category) : ?>
                                <div class="tutorial-badge"><?php echo esc_html($tutorial_category); ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="tutorial-content">
                            ...
                            <div class="tutorial-meta">
                                <?php if ($tutorial_duration) : ?>
                                    <span>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <polyline points="12,6 12,12 16,14"></polyline>
                                        </svg>
                                        <?php echo esc_html($tutorial_duration); ?>
                                    </span>
                                <?php endif; ?>
                                
                                <?php if ($tutorial_difficulty) : ?>
                                    <span>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
                                        </svg>
                                        <?php echo esc_html($tutorial_difficulty); ?>
                                    </span>
                                <?php endif; ?>
                            </div>
                            ...
                            <a href="<?php the_permalink(); ?>" class="tutorial-button">
                                Start Tutorial
        ...
        <?php else : ?>
            <div class="empty-state">
                ...
                <p>We're currently working on adding more tutorials. Please check back soon!</p>
            </div>
        <?php endif; ?>
    </div>
</div>

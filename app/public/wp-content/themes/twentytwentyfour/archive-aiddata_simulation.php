<?php
/**
 * Template Name: Simulation Archive
 * Description: Archive page for AidData simulations
 *
 * @package WordPress
...
<div class="loading-screen">
    ...
    <div class="loading-content">
        ...
        <p class="loading-text">Loading Simulations</p>
    </div>
</div>
    ...
    <div class="archive-hero">
        <div class="archive-hero-content">
            ...
            <p class="archive-description">
                Interactive simulations that let you experience real-world scenarios in development finance, policy-making, and strategic decision-making.
            </p>
        </div>
    </div>
    ...
    <div class="main-content">
        <?php if (have_posts()) : ?>
            <div class="simulations-grid">
                <?php while (have_posts()) : the_post(); 
                    $simulation_price = get_post_meta(get_the_ID(), '_simulation_price', true);
                    $simulation_duration = get_post_meta(get_the_ID(), '_simulation_duration', true);
                    $simulation_difficulty = get_post_meta(get_the_ID(), '_simulation_difficulty', true);
                    $simulation_type = get_post_meta(get_the_ID(), '_simulation_type', true);
                    $passing_score = get_post_meta(get_the_ID(), '_simulation_passing_score', true);
                    
                    $price_display = empty($simulation_price) || $simulation_price == '0' ? 'Free' : '$' . number_format(floatval($simulation_price), 2);
                ?>
                    <article class="simulation-card">
                        <div class="simulation-image">
                            ...
                            <?php endif; ?>
                            <div class="simulation-price"><?php echo esc_html($price_display); ?></div>
                            <?php if ($simulation_difficulty) : ?>
                                <div class="simulation-difficulty"><?php echo esc_html($simulation_difficulty); ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="simulation-content">
                            ...
                            <div class="simulation-meta">
                                <?php if ($simulation_duration) : ?>
                                    <span>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <circle cx="12" cy="12" r="10"></circle>
                                            <polyline points="12,6 12,12 16,14"></polyline>
                                        </svg>
                                        <?php echo esc_html($simulation_duration); ?>
                                    </span>
                                <?php endif; ?>
                            ...
                            <div class="simulation-features">
                                <span class="feature-tag">Interactive Scenarios</span>
                                <span class="feature-tag">Real-time Feedback</span>
                                <span class="feature-tag">Decision Making</span>
                                <?php if ($simulation_type) : ?>
                                    <span class="feature-tag"><?php echo esc_html(ucfirst($simulation_type)); ?></span>
                                <?php endif; ?>
                            </div>
                            
                            <div class="simulation-excerpt">
                                <?php the_excerpt(); ?>
                            </div>
                            
                            <a href="<?php the_permalink(); ?>" class="simulation-button">
                                Start Simulation
        ...
        <?php else : ?>
            <div class="empty-state">
                ...
                <p>We're currently working on adding more interactive simulations. Please check back soon!</p>
            </div>
        <?php endif; ?>
    </div>
</div>

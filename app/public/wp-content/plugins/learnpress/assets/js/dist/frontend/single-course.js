    ...
    if (this.elBtnCompleteItem.length) {
      this.elBtnCompleteItem.forEach(element => {
        element.addEventListener('click', e => {
          ...
          const title = form && form.dataset.title ? form.dataset.title : target.dataset.title || '';
          const confirmMessage = form && form.dataset.confirm ? form.dataset.confirm : target.dataset.confirm || 'Are you sure?';
          _utils_lp_modal_overlay__WEBPACK_IMPORTED_MODULE_0__["default"].elLPOverlay.show();
          _utils_lp_modal_overlay__WEBPACK_IMPORTED_MODULE_0__["default"].setTitleModal(title);
          _utils_lp_modal_overlay__WEBPACK_IMPORTED_MODULE_0__["default"].setContentModal('<div class="pd-2em">' + confirmMessage + '</div>');

...
const exitWarningMessage = ( window.lpGlobalSettings &&
	window.lpGlobalSettings.localize &&
	window.lpGlobalSettings.localize.quiz_exit_warning ) ||
	'You have a quiz in progress. Leaving now will clear your answers.';

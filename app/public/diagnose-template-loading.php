...
<body>
    ...
    <div class="info">
        ...
        <p>
            <a href="<?php echo get_permalink($tutorial_id); ?>" target="_blank" style="display: inline-block; background: #026447; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
                View Tutorial
            </a>
        </p>

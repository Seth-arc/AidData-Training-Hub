...
<head>
    ...
    <style>
        ...
        h1 { color: #026447; margin-top: 0; }
        h2 { color: #333; border-bottom: 2px solid #026447; padding-bottom: 10px; margin-top: 30px; }
        ...
        .btn { display: inline-block; background: #026447; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; margin: 10px 10px 10px 0; }
